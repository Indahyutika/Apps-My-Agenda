                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="myagenda_user_nama" name="myagenda_user_nama" placeholder="Nama Sekolah">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="email" class="form-control" id="myagenda_user_email" name="myagenda_user_email" placeholder="Email">
                                        <span class="input-group-text">@example.com</span>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <label for="myagenda_user_password" class="form-label">Password</label>
                                    <div class="input-group">
