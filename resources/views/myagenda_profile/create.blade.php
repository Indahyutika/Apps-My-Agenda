...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @if ($errors->any())
            ...
            @endif
            <form action="{{ route('myagenda_profile.store') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-center">
                                    ...
                                    <input type="text" class="form-control text-center" id="myagenda_profile_nama"
                                        name="myagenda_profile_nama" value="{{ Auth::user()->myagenda_user_nama }}" readonly>
                                </div>
